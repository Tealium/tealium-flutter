...
// Under Swift Package Manager, tealium-swift exposes granular products instead of
// the `TealiumSwift` umbrella module; import only the modules whose symbols are used.
#if SWIFT_PACKAGE
    import TealiumCore
#else
    import TealiumSwift
